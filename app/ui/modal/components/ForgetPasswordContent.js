System.register(['angular2/core', 'app/ui/modal/models/ModalDialogInstance'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ForgetPasswordContent = (function () {
                function ForgetPasswordContent(dialogInstance) {
                    this.dialogInstance = dialogInstance;
                }
                ForgetPasswordContent.prototype.beforeDismiss = function () {
                    return false;
                };
                ForgetPasswordContent.prototype.beforeClose = function () {
                    return false;
                };
                ForgetPasswordContent = __decorate([
                    core_1.Component({
                        // selector:'forgetpw-modal-content',
                        template: "<div>ForgetPasswordContent</div>",
                        providers: [ModalDialogInstance_1.ModalDialogInstance]
                    }), 
            ...
            exports_1("ForgetPasswordContent", ForgetPasswordContent);
        }
    }
});
//# sourceMappingURL=ForgetPasswordContent.js.map